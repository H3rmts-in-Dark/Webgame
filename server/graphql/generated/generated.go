...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "changeSetting":
			out.Values[i] = ec._Mutation_changeSetting(ctx, field)
		...
		case "reloadSite":
			out.Values[i] = ec._Mutation_reloadSite(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) _Return(ctx context.Context, sel ast.SelectionSet, obj *model.Return) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "ok":
			out.Values[i] = ec._Return_ok(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "info":
			out.Values[i] = ec._Return_info(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) _Setting(ctx context.Context, sel ast.SelectionSet, obj *model.Setting) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "admin":
			out.Values[i] = ec._Setting_admin(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
